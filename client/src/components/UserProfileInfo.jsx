      ...
      <div className="flex flex-col md:flex-row items-start gap-6">
        ...
        <div className="w-full pt-16 md:pt-0 md:pl-36 ">
          <div className="flex flex-col md:flex-row items-start justify-between">
            ...
            {/* display editProfile to loggedIn user only */}
            {
              !profileId &&
              <button onClick={() => setShowEdit(true)} className="flex items-center gap-2 border border-gray-300 hover:bg-gray-100 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0 cursor-pointer">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 mt-4">
            <span className="flex items gap-1.5">
          ...
          <div className="flex items-center gap-6 mt-6 border-t border-gray-200 pt-4">
            <div>
              ...
              <span className="text-xl sm:text-sm  text-gray-500 ml-1.5">Posts</span>
            </div>
            <div>
              <span className="sm:text-xl font-bold text-gray-900">{user.followers.length}</span>
              <span className="text-xl sm:text-sm  text-gray-500 ml-1.5">Followers</span>
            </div>
            <div>
              <span className="sm:text-xl font-bold text-gray-900">{user.following.length}</span>
              <span className="text-xl sm:text-sm  text-gray-500 ml-1.5">Following</span>
            </div>
          </div>
        </div>
      </div>
