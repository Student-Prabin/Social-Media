      ...
      <div className="p-5 md:px-10 h-full overflow-y-scroll">
        ...
        <div className="px-4">
          <div className="flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5">
            ...
            <button onClick={sendMessage} className="bg-gradient-to-br from-indigo-500 to bg-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 cursor-pointer text-white p-2 rounded-full">
